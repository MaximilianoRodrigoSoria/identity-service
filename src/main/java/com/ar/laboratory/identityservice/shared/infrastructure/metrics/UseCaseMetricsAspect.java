package com.ar.laboratory.identityservice.shared.infrastructure.metrics;
...
public class UseCaseMetricsAspect {
     ...
     */
    @Around(
            "execution(* com.ar.laboratory.identityservice..application.inbound.command..*(..))"
                    + " && !within(com.ar.laboratory.identityservice..infrastructure..*)")
